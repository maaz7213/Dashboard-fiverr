...
const Reasons = () => {
  ...
  <div>
  <strong>{reasonItem.reason} </strong>
  </div>
    
  </div>
  <div>
    {reasonItem.additionalDetails}
    </div>
  <div className="button-group">
  
    <button className="edit-btn" onClick={() => handleEdit(reasonItem)}>Edit</button>
    <button className="delete-btn" onClick={() => handleDelete(reasonItem._id)}>Delete</button>
  </div>
</div>
